...
exports.testCmd = (rl, id) => {
    if (!id) {
        ...
        try {
            ...
            const response = quiz.answer;
            /**
             * notas internas, question genera una pregunta del paquete readline,
             * en este ejemplo de test, se genera una pregunta del quizz y compara la respuesta dada
             * con el de la BD
             */
            rl.question(colorize(`${question}? `, 'red'), (answer) => {
                log('Su repuesta es:');
                (answer == response) ? biglog('Correcta', 'green') : biglog('Incorrecta', 'red');
